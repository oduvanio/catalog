...
{groups:}
	...
	<div style="clear: both; margin-bottom: 5px;">
		...
		| <a href="?{crumb}/producers">Производители</a>
		| <a href="?{crumb}/change">{infra.conf.catalog.change.title}</a>
	</div>
{logo:}
	<img src="?*imager/imager.php?w=300&src={infra.conf.catalog.dir}{producer}/{article}/" style="margin:0 0 5px 5px;">
{cat_item:}
	<div class="position">
...
{s_tr:}<tr>
{e_tr:}</tr>
{img:}<img src="?{infra.conf.catalog.dir}{pos.producer}/{pos.article}/&w=100&h=80">
{pages:}
	<ul class="pagination">
